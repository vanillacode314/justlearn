...
const Question = (0, import_index_62ca9411.c)(($$result, $$props, $$bindings, slots) => {
  let questionNo;
  let { question } = $$props;
  let { index = -1 } = $$props;
  let { answer } = $$props;
  ...
  $$result.css.add(css);
  questionNo = index + 1;
  return `<article class="${"svelte-he0zcl"}">${(question == null ? void 0 : question.image) ? `<img${(0, import_index_62ca9411.d)("src", question.image, 0)} alt="${"question"}" class="${"svelte-he0zcl"}">` : ``}
	<h2 class="${"svelte-he0zcl"}">Q${(0, import_index_62ca9411.g)(questionNo > 0 ? questionNo : "")})
		<span>${(0, import_index_62ca9411.g)(question.text)}</span></h2>
	<div class="${"options svelte-he0zcl"}">${(0, import_index_62ca9411.f)(question.options, (option) => {
    return `<label class="${"svelte-he0zcl"}"><input type="${"radio"}"${(0, import_index_62ca9411.d)("name", String(question.id), 0)}${(0, import_index_62ca9411.d)("value", option.id, 0)}${option.id === answer ? (0, import_index_62ca9411.d)("checked", true, 1) : ""}>
					${(option == null ? void 0 : option.text) ? `${(0, import_index_62ca9411.g)(option.text)}` : ``}
					${(option == null ? void 0 : option.image) ? `<img${(0, import_index_62ca9411.d)("src", option.image, 0)} alt="${"option " + (0, import_index_62ca9411.g)(option.id)}" class="${"svelte-he0zcl"}">` : ``}
				</label>`;
  })}</div>
</article>`;
});
